...
public class CryptoOutputStream extends FilterOutputStream implements 
  ...
  public CryptoOutputStream(OutputStream out, CryptoCodec codec, 
    ...
    this(out, codec, bufferSize, key, iv, 0, pool);
  }
  
  public CryptoOutputStream(OutputStream out, CryptoCodec codec, 
      int bufferSize, byte[] key, byte[] iv, long streamOffset, DirectBufferPool pool)
      throws IOException {
    super(out);
  ...
  public CryptoOutputStream(OutputStream out, CryptoCodec codec, 
    ...
    this(out, codec, key, iv, 0, pool);
  }
  
  public CryptoOutputStream(OutputStream out, CryptoCodec codec, 
      byte[] key, byte[] iv, long streamOffset, DirectBufferPool pool) throws IOException {
    this(out, codec, CryptoStreamUtils.getBufferSize(codec.getConf()), 
        key, iv, streamOffset, pool);
  }
