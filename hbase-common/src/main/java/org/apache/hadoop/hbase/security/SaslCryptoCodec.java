...
import org.apache.hadoop.hbase.crypto.CryptoInputStream;
import org.apache.hadoop.hbase.crypto.CryptoOutputStream;
...
public class SaslCryptoCodec {
  ...
  public SaslCryptoCodec(Configuration conf, CipherOption cipherOption,
    ...
    cIn = new CryptoInputStream(null, codec,
        isServer ? inKey : outKey, isServer ? inIv : outIv, POOL);
    cOut = new CryptoOutputStream(new ByteArrayOutputStream(), codec,
        isServer ? outKey : inKey, isServer ? outIv : inIv, POOL);
  ...
  public void dispose() throws SaslException {
    try {
      ...
      throw new SaslException("Dispose failed", ioe);
    }
  }
