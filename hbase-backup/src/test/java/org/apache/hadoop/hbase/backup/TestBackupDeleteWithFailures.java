...
public class TestBackupDeleteWithFailures extends TestBackupBase{
  ...
  public static class MasterSnapshotObserver extends  BaseMasterObserver {
  ...
  private MasterSnapshotObserver getMasterSnapshotObserver() {
    return (MasterSnapshotObserver) TEST_UTIL.getHBaseCluster().getMaster().getMasterCoprocessorHost()
        .findCoprocessor(MasterSnapshotObserver.class.getName());
  }
