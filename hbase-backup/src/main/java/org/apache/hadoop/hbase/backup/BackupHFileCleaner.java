...
public class BackupHFileCleaner extends BaseHFileCleanerDelegate implements Abortable {
  ...
  public Iterable<FileStatus> getDeletableFiles(Iterable<FileStatus> files) {
    ...
    ArrayList<FileStatus> deletables = new ArrayList<FileStatus>();
    for (FileStatus file: files) {
      if (isFileDeletable(file, hfileRefs)) {
        deletables.add(file);
      }
    }
    return deletables;
  ...
  public boolean isFileDeletable(FileStatus file, Set<String> hfileRefs) {
