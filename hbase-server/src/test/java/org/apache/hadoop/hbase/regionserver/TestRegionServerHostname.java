...
public class TestRegionServerHostname {
  ...
  public void testInvalidRegionServerHostnameAbortsServer() throws Exception {
    ...
    try {
      ...
      if (!msg.contains("Failed resolve of ") || !msg.contains(invalidHostname)) {
        msg = t2.getCause().getMessage();
        assertTrue(msg.contains("Failed resolve of ") && msg.contains(invalidHostname));
      }
      return;
    } finally {
