...
public class TestSecureBulkLoadEndpoint {
  ...
  public void testFileSystemsWithoutPermissionSupport() {
    ...
    Set<String> defaultIgnoredSchemes = endpoint.getFileSystemSchemesWithPermissionSupport(emptyConf);
    ...
    defaultIgnoredSchemes = endpoint.getFileSystemSchemesWithPermissionSupport(defaultConf);
    assertEquals(defaultIgnoredSchemes, expectedDefaultIgnoredSchemes);
