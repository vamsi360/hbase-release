...
public class AuthUtil {
   ...
   */
  public static Chore getAuthChore(Configuration conf) throws IOException {
    ...
    Chore refreshCredentials =
        new Chore("RefreshCredentials", CHECK_TGT_INTERVAL, stoppable) {
      @Override
